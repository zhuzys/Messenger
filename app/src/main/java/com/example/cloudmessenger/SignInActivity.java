...
import com.example.cloudmessenger.databinding.ActivitySignInBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnsignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.show();
                auth.signInWithEmailAndPassword(binding.email.getText().toString(), binding.etPassword.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
